...
class GetLapTimesForDriverAndRaceRequest extends Request implements Cacheable, HasRequestPagination, Paginatable
{
    /**
    ...
    {
        return "/{$this->season}/{$this->round}/drivers/{$this->driverSlug}/laps.json";
    }
